# Data Processing for Data Science for Dynamic Intervention Decision Making Center (d3c) Users

## Description

The material in this repository contains code documenting transformations on curated datasets and brief intake notes contextualizing the motivation for the documented data transformations. Currently, the code in this repository is only applicable to the Mobile Assistance for Regulating Smoking (MARS) Micro-Randomized Trial (MRT).
